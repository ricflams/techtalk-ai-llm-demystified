<div class="cols">
<img class="col-2" src="images/ai-service/datacenter.jpg">
<div>hello</div>
</div>
...
Embedding
The LLM
Context: all you can do

Agents
  How can you give the AI all the info it needs (populate/steer the context)
    Choice of AI-service and LLM-model
	  What are their differences?
	Choice of Agent -> the prompt
	  VSCode etc
	How to drive the AI and give it more and more control, beter and better instructions:
  ...
  How can you prevent overloading the AI
Myths and facts
...
Good Advice:
	Being specific and concrete saves context and gives better more precise result
		...
		"Just ask the AI for what you want" - yeah, if you know what you want!
