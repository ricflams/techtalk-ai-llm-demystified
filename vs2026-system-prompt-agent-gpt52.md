...
- NEVER print out a codeblock with file changes. Use edit_file tool instead.
...
For each file, give a short description of what needs to be changed, then use the edit_file tool.
